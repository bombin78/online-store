...
<html lang="ru">
<head>
	<title>О доставке и оплате</title>
	<meta charset="utf-8">
	...
	<link rel="stylesheet" href="css/about-purchase.css">
...
<?php
	...
	require_once 'data-emulation/php/data-about-purchase.php';

	$template = $twig->load('templates/pages/about-purchase_grid-2.twig');
