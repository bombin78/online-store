var dataEmulation = {
//---------------------------------------------------
	//ПРЕФИКС ДЛЯ КЛАССОВ И МОДИФИКАТОРОВ
	prefix: 'su-',
	//---------------------------------------------------
	...
	typeTemplate: '_su-normal',
	//---------------------------------------------------

	//---------------------------------------------------
	//HEADER
	//1. Тип шапки по умолчанию
	typeHeader: '_su-guest',
		...
		data: [
			...
			},
			{
				...
				dropdown: [
					...
					{
						modifier: '_su-list', href: '#', title: 'Средства по уходу за ногтямииииииииииииииииииииииииииииииииииииииииииии',
						sublist: [
							{modifier: '', href: '#', title: 'Средства по уходу за ногтямиииииииииииииии 1'},
							{modifier: '', href: '#', title: 'Средства по уходу за ногтями ногтями ногтями ногтями ногтями2'},
							{modifier: '', href: '#', title: 'Средства по уходу за ногтямиииииииииииииииииииииииииииииииииииииииииии 3'},
	...
	//6. Copyright block
	footerCopyright: '&copy; Интернет-магазин «Маникюр Шоп», 2007–2017, <a class="su-link" href="#" title="на главную">профессиональные товары для ногтей</a>',

	//7. Developer block
	footerDeveloper: 'Компания "Название компании"',
//---------------------------------------------------
