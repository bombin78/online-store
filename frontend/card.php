...
<head>
	...
	<link rel="stylesheet" href="vendors/fancybox-1.3.4/css/jquery.fancybox-1.3.4.css">
...
<?php
	...
	require_once 'data-emulation/php/data-card.php';

	$template = $twig->load('templates/pages/card_grid-2.twig');
