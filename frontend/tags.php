...
<?php
	...
	require_once 'data-emulation/php/data-tags.php';

	$template = $twig->load('templates/pages/tags_grid-2.twig');
	...
	echo $template->render([
		...
		'tagsPage' 				=> $dataEmulation['tagsPage'],
		'listTags'         		=> $dataEmulation['listTags']
	]);
?>
</body>
</html>